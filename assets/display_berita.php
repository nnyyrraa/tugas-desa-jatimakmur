    ...
    <div class="col-lg-12">
    	<section class="panel">
            ...
            <table class="table table-striped table-advance table-hover">
                <tbody>
                    <tr>
					<th><i class="fa fa-thumb-tack"></i> Judul</th>
						<th><i class="fa fa-bookmark"></i> Headline</th>
						<th><i class="fa fa-pencil-square-o"></i> Isi</th>
						<th><i class="fa fa-inbox"></i> Pengirim</th>
		...
		<a class="btn btn-primary" href="index.php?page=input_berita&id=<?php echo $id;?>"><i class="icon_plus_alt2"></i>&nbsp;&nbsp;&nbsp;Tambah Berita</a>
    </div>
</div>