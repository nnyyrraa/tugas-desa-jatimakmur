                    ...
                    <ul class="s-header__nav">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="login_user.php">Lihat Profil</a></li>
                                <li><a href="login_user.php">Wilayah Administratif</a></li>
                                <li><a href="login_user.php">Kelompok Umur</a></li>
                            </ul>
                        </li>
    ...
    <div class="container" style="margin-top: -124px;">
      <form class="login-form" action="" method="POST">        
        <div class="login-wrap" style="margin-bottom: -15px;">
            <p class="login-img" style="margin-bottom: 20px;"><i class="icon_lock_alt"></i></p>
            ...
            <button class="btn btn-primary btn-lg btn-block" type="submit" name="submit">Registrasi</button>
            <b style="color: black;">Sudah punya akun? <a href="login_user.php">Login Disini</a></b>
        </div>
      </form>
    </div>
